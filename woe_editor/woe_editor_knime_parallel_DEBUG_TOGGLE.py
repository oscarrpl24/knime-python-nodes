# =============================================================================
# WOE Editor for KNIME Python Script Node - PARALLEL VERSION - DEBUG TOGGLE
# =============================================================================
...
# Version: 2.0-DEBUG-TOGGLE (Parallel)
# =============================================================================
...
if DEBUG_MODE:
    logger.info("=" * 70)
    logger.info("WOE EDITOR (PARALLEL) - DEBUG TOGGLE VERSION")
...
if contains_dv:
    ...
    if constant_vars and DEBUG_MODE:
...
if DEBUG_MODE:
    ...
    logger.info("=" * 70)
    logger.info(f"WOE Editor (Parallel DEBUG TOGGLE) completed at: {datetime.now().isoformat()}")
