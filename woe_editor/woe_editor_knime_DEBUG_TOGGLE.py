# =============================================================================
# WOE Editor for KNIME Python Script Node - DEBUG TOGGLE VERSION
# =============================================================================
...
def setup_debug_logging():
    ...
    if DEBUG_MODE:
        ...
        # When debug is off, set to CRITICAL to suppress all but critical messages
    ...
    for var in x_vars:
        ...
        if bin_col in result_df.columns:
            ...
            if missing_woe_count > 0:
                ...
                for unmapped_bin in result_df.loc[result_df[woe_col].isna(), bin_col].unique():
...
if DEBUG_MODE:
    logger.info("=" * 70)
    logger.info("WOE EDITOR - DEBUG TOGGLE VERSION")
...
if contains_dv:
    ...
    # =========================================================================
    log_progress("=" * 60)
    log_progress(f"WOE EDITOR - HEADLESS MODE (DEBUG_MODE={DEBUG_MODE})")
    log_progress("=" * 60)
...
if DEBUG_MODE:
    ...
    logger.info("=" * 70)
    logger.info(f"WOE Editor (DEBUG TOGGLE) completed at: {datetime.now().isoformat()}")
