# =============================================================================
# Scorecard Generator for KNIME Python Script Node - DEBUG VERSION
# =============================================================================
# This is the DEBUG version with extensive logging on every function.
# Use this version to trace execution flow and diagnose issues.
# 
...
debug.log("=" * 70)
debug.log("SCORECARD GENERATOR DEBUG VERSION - Starting initialization")
debug.log("=" * 70)
...
def create_scorecard_app(coefficients: pd.DataFrame, bins: pd.DataFrame):
    ...
    app_ui = ui.page_fluid(
        ...
        ui.h3("Scorecard Generator (DEBUG MODE)"),
...
print("Scorecard Generator Node (DEBUG) - Starting...")
print("=" * 70)
...
debug.log("=" * 70)
debug.log("SCORECARD GENERATOR DEBUG VERSION - Complete")
debug.log("=" * 70)
