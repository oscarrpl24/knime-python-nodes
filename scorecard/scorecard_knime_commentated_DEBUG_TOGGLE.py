# =============================================================================
# Scorecard Generator for KNIME Python Script Node - COMMENTATED DEBUG TOGGLE VERSION
# =============================================================================
# This is the COMMENTATED DEBUG TOGGLE VERSION of scorecard_knime.py
# Every line of code is explained in plain English for educational purposes,
# AND debug logging can be toggled on/off with the DEBUG_ENABLED flag.
# =============================================================================
#
# WHAT IS A SCORECARD?
# --------------------
...
# Version: 1.0-COMMENTATED-DEBUG-TOGGLE
# =============================================================================
...
#
# All logging respects the DEBUG_ENABLED flag at the top of the script.
...
class DebugLogger:
    ...
    IMPORTANT: All logging methods check DEBUG_ENABLED before outputting.
    When DEBUG_ENABLED is False, all methods become no-ops for performance.
    
    Example output (when DEBUG_ENABLED=True):
    ...
    def enter_function(self, func_name: str, **kwargs):
        ...
        """
        # Check if debugging is enabled before doing any work
...
def debug_trace(func):
    ...
    that adds no overhead to function calls.
    ...
    """
    # When debugging is disabled, return the function unchanged
    # This avoids the overhead of wrapper function calls
    if not DEBUG_ENABLED:
        return func
...
debug.log("=" * 70)
debug.log("SCORECARD GENERATOR COMMENTATED DEBUG TOGGLE VERSION - Starting initialization")
...
# 
# The UI and server code are logged when DEBUG_ENABLED is True.
...
def create_scorecard_app(coefficients: pd.DataFrame, bins: pd.DataFrame):
    ...
    if DEBUG_ENABLED:
        title_text = "Scorecard Generator (COMMENTATED DEBUG MODE)"
    else:
        title_text = "Scorecard Generator"
...
# Debug logging traces every step when DEBUG_ENABLED is True.
...
print("Scorecard Generator Node (COMMENTATED DEBUG TOGGLE) - Starting...")
if DEBUG_ENABLED:
...
debug.log("=" * 70)
debug.log("SCORECARD GENERATOR COMMENTATED DEBUG TOGGLE VERSION - Complete")
debug.log("=" * 70)
...
#
# To toggle debugging:
# - Set DEBUG_ENABLED = True at the top of the script for verbose logging
# - Set DEBUG_ENABLED = False for minimal logging (production use)
# =============================================================================
