...
# This version includes toggleable debug logging for troubleshooting
...
def setup_logging():
    ...
    logger = logging.getLogger('RejectInference_TOGGLE')
    ...
    if DEBUG:
        ...
        # Disable logging by using NullHandler and setting high level
...
def debug_trace(func):
    ...
    if not DEBUG:
        # When DEBUG is False, return the function unchanged (no overhead)
        return func
