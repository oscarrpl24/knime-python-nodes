# =============================================================================
# CCR Score Filter Node for KNIME - DEBUG VERSION
# =============================================================================
# Purpose: Converts CCR.score (string) to numeric and filters by cutoff value
# 
# DEBUG VERSION: This version includes extensive debug logging on every operation
...
debug_separator("CCR SCORE FILTER - DEBUG VERSION")
...
debug_log("CCR Score Filter DEBUG script execution completed")
debug_separator()
