...
DEBUG_LOGGER = logging.getLogger('variable_selection_debug')
...
try:
    file_handler = logging.FileHandler('variable_selection_debug.log', mode='a', encoding='utf-8')
...
debug_log("=" * 80)
debug_log("DEBUG VERSION - Variable Selection Node Starting")
...
debug_log("=" * 80)
debug_log("DEBUG SESSION COMPLETE")
debug_log(f"Timestamp: {datetime.now().isoformat()}")
debug_log("=" * 80)
