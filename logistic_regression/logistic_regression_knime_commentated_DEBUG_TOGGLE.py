# =============================================================================
# Logistic Regression for KNIME Python Script Node - DEBUG TOGGLE VERSION
# =============================================================================
...
#
# DEBUG TOGGLE VERSION: Set DEBUG_MODE to True/False to enable/disable logging
#
...
# When DEBUG_MODE is False, only warnings and errors are logged.

# Create a logger instance for this module
logger = logging.getLogger('LogisticRegression_Commentated_DEBUG_TOGGLE')

# Set the logging level based on DEBUG_MODE
if DEBUG_MODE:
    logger.setLevel(logging.DEBUG)
else:
    logger.setLevel(logging.WARNING)  # Only show warnings and errors when debug is off
...
def debug_log_function(func):
    ...
    def wrapper(*args, **kwargs):
        # When debug mode is off, just call the function directly
        if not DEBUG_MODE:
...
# =============================================================================
# Note: The Shiny UI code is included here with minimal comments in the
# toggle version since the main focus is on the core modeling logic.
...
def create_logistic_regression_app(df: pd.DataFrame):
    ...
    debug_label = " [DEBUG MODE]" if DEBUG_MODE else ""
    
    # UI definition (abbreviated for toggle version - see non-debug for full comments)
    app_ui = ui.page_fluid(
        ...
        ui.h4(f"🔬 Logistic Regression{debug_label}"),
...
# =============================================================================
log_checkpoint("=" * 70)
log_checkpoint("LOGISTIC REGRESSION NODE - COMMENTATED DEBUG TOGGLE VERSION - STARTING")
log_checkpoint("=" * 70)

if DEBUG_MODE:
    print("Logistic Regression Node - COMMENTATED DEBUG TOGGLE (DEBUG ON) - Starting...")
else:
...
log_checkpoint("=" * 70)
log_checkpoint("LOGISTIC REGRESSION NODE - COMMENTATED DEBUG TOGGLE VERSION - FINISHED")
log_checkpoint("=" * 70)
