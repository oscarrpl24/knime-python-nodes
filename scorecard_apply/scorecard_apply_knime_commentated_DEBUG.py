# =============================================================================
# Scorecard Apply (Scoring) for KNIME Python Script Node - DEBUG VERSION
# =============================================================================
# 
# DEBUG VERSION: This version includes extensive debug logging for every function
# to help trace execution flow, parameter values, and return values.
#
# PURPOSE:
...
logger = logging.getLogger('ScorecardApply_Commentated_DEBUG')
...
def log_function_call(func):
    ...
    This decorator wraps any function to automatically log:
    ...
    Returns:
        wrapper: A wrapped function that includes logging
    """
...
def is_interaction_term(var_name: str) -> bool:
    ...
    """
    # Log the incoming variable name for debugging
...
logger.info("=" * 80)
logger.info("SCORECARD APPLY NODE - COMMENTATED DEBUG VERSION - STARTING")
logger.info("=" * 80)
print("Scorecard Apply Node (Commentated DEBUG VERSION) - Starting...")
...
# - Exception tracebacks are fully logged
# - Check the KNIME console or log files for detailed debug output
# =============================================================================
