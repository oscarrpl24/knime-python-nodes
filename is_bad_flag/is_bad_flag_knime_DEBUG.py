# =============================================================================
# Is Bad Flag Node for KNIME - DEBUG VERSION
# =============================================================================
...
#
# DEBUG VERSION: Extensive logging on every function
# =============================================================================
...
def debug_function(func):
    """Decorator to add entry/exit logging to functions."""
    @wraps(func)
...
def main():
    ...
    logger.info("="*70)
    logger.info("IS BAD FLAG NODE - DEBUG VERSION - STARTING EXECUTION")
    logger.info("="*70)
