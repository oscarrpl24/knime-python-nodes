# =============================================================================
# IS BAD FLAG NODE FOR KNIME - FULLY COMMENTATED DEBUG VERSION
# =============================================================================
#
# OVERVIEW:
# ---------
...
# trace execution, diagnose issues, and understand data flow.
#
# WHAT IS GRODI26_wRI?
# --------------------
...
def setup_logging() -> logging.Logger:
    ...
    - DEBUG level logging (captures all log messages)
    ...
    By setting DEBUG level, we capture everything.
    """
...
def debug_function(func):
    ...
    When my_function is called, you'll see:
...
def read_input_table() -> pd.DataFrame:
    ...
    # Log KNIME input table information
...
def validate_required_column(df: pd.DataFrame, column_name: str = "GRODI26_wRI") -> bool:
    ...
    # Log all available columns with their data types
    ...
    if not column_exists:
        ...
        # Search for similar column names (case-insensitive)
        # This helps users identify typos or case mismatches
    ...
    # Log numeric statistics if applicable
    ...
    # Show first 10 values for inspection
...
def write_output_table(df: pd.DataFrame) -> bool:
    ...
    # Log comprehensive output DataFrame details
    logger.debug(f"Output DataFrame shape: {df.shape}")
    ...
    # Check for potential issues before writing
    logger.debug("Checking for potential output issues...")
    
    # Check for infinite values in numeric columns
    numeric_cols = df.select_dtypes(include=['number']).columns
    for col in numeric_cols:
        # Check for infinity (handling nulls properly)
...
def main() -> None:
    ...
    logger.info("="*70)
    logger.info("IS BAD FLAG NODE - COMMENTATED DEBUG VERSION - STARTING EXECUTION")
    logger.info("="*70)
