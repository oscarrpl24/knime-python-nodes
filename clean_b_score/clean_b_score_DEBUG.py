# ==============================================================================
# KNIME Python Script: Clean b_Score Column (DEBUG VERSION)
# ==============================================================================
...
#
# DEBUG VERSION: This version includes extensive logging for troubleshooting
# ==============================================================================
...
def setup_logger(name: str = "clean_b_score_DEBUG", level: int = logging.DEBUG) -> logging.Logger:
    """
...
logger.info("=" * 70)
logger.info("CLEAN B_SCORE SCRIPT - DEBUG VERSION")
logger.info("=" * 70)
