# ==============================================================================
# KNIME Python Script: Clean b_Score Column (Fully Commentated TOGGLE VERSION)
# ==============================================================================
#
# PURPOSE:
...
#
# TOGGLE VERSION:
# This version includes comprehensive logging that can be enabled/disabled
# via the DEBUG_MODE boolean at the top of the script.
#
# WHY THIS IS NEEDED:
...
def setup_comprehensive_logger(
    name: str = "clean_b_score_commentated_TOGGLE",
    ...
    if DEBUG_MODE:
        ...
        # When DEBUG_MODE is False, disable all logging
...
logger.info("CLEAN B_SCORE SCRIPT - FULLY COMMENTATED TOGGLE VERSION")
...
# ==============================================================================
#
# SUMMARY OF WHAT THIS TOGGLE VERSION DOES:
# 1. Sets up comprehensive logging to stdout (when DEBUG_MODE = True)
...
#
# TOGGLING DEBUG MODE:
# - Set DEBUG_MODE = True at the top of the script for verbose logging
# - Set DEBUG_MODE = False for silent operation (production use)
#
# DEBUGGING WITH THIS SCRIPT (when DEBUG_MODE = True):
