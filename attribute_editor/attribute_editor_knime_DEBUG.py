# =============================================================================
# Attribute Editor for KNIME Python Script Node - DEBUG VERSION
# =============================================================================
...
# Version: 1.3-DEBUG - Debug version with extensive logging
# =============================================================================
...
logger.info("Starting Attribute Editor DEBUG version")
...
def create_attribute_editor_app(df: pd.DataFrame, initial_dv: Optional[str] = None):
    ...
    try:
        ...
        app_ui = ui.page_fluid(
            ...
            ui.h4("Attribute Editor (DEBUG MODE)"),
...
logger.info("="*80)
logger.info("ATTRIBUTE EDITOR DEBUG VERSION - MAIN EXECUTION STARTING")
logger.info("="*80)
...
logger.info("="*80)
logger.info("ATTRIBUTE EDITOR DEBUG VERSION - EXECUTION COMPLETE")
logger.info("="*80)
