# =============================================================================
# COLUMN SEPARATOR NODE FOR KNIME - FULLY COMMENTATED TOGGLE DEBUG VERSION
# =============================================================================
#
# FILE NAME: column_separator_knime_commentated_TOGGLE.py
#
# TOGGLE DEBUG VERSION: This script includes extensive debug logging on every 
# function, operation, and decision point. Debug logging can be enabled or 
# disabled via the DEBUG_ENABLED flag at the top of the script.
#
...
# When disabled, the script runs faster with minimal output.
# =============================================================================
...
# They are only imported when DEBUG_ENABLED is True to avoid unnecessary overhead.
if DEBUG_ENABLED:
...
# =============================================================================
# SECTION 3: DEBUG LOGGING CONFIGURATION
# =============================================================================
...
# Only configured when DEBUG_ENABLED is True.
# =============================================================================
...
# =============================================================================
# SECTION 4: FUNCTION DECORATOR FOR AUTOMATIC DEBUG LOGGING
# =============================================================================
...
# Only active when DEBUG_ENABLED is True.
# =============================================================================
...
if DEBUG_ENABLED:
    ...
    # This decorator simply returns the original function unchanged
    def debug_log(func):
        return func


# =============================================================================
# SECTION 5: SCRIPT EXECUTION START
# =============================================================================
...
# =============================================================================
# SECTION 7: DEFINE THE COLUMN CLASSIFICATION FUNCTION
# =============================================================================
...
# =============================================================================
# SECTION 8: SEPARATE COLUMNS INTO TWO GROUPS
# =============================================================================
...
# =============================================================================
# SECTION 9: CREATE OUTPUT DATAFRAMES
# =============================================================================
...
# =============================================================================
# SECTION 10: LOGGING / SUMMARY OUTPUT
# =============================================================================
...
# =============================================================================
# SECTION 11: WRITE OUTPUTS TO KNIME
# =============================================================================
...
# =============================================================================
# SECTION 12: SCRIPT COMPLETE - FINAL STATISTICS
# =============================================================================
...
# 1. Check DEBUG_ENABLED flag to determine logging behavior
# 2. Configure logging infrastructure for debug output (if enabled)
# 3. Define helper functions and decorators for automatic logging
# 4. Import the KNIME I/O module
# 5. Read the input table from KNIME's first input port (with logging if enabled)
# 6. Define a function to classify columns based on naming patterns (decorated)
# 7. Loop through all columns and categorize them into two groups (with logging)
# 8. Create two separate DataFrames from those groups (with logging)
# 9. Print a summary of the separation for standard output
# 10. Send both DataFrames to KNIME's output ports (with logging)
# 11. Report final execution statistics (if DEBUG_ENABLED)
#
# DEBUGGING WITH THIS SCRIPT:
# - Set DEBUG_ENABLED = True at the top to enable full debug output
# - Set DEBUG_ENABLED = False for production use with minimal output
