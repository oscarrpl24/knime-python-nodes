# =============================================================================
# Column Separator Node for KNIME - DEBUG VERSION
# =============================================================================
# Purpose: Separates columns into two outputs based on naming patterns
# 
# DEBUG VERSION: Contains extensive logging for every function and operation
# 
...
# =============================================================================
# Configure comprehensive logging for debugging purposes
logging.basicConfig(
    level=logging.DEBUG,
...
def should_go_to_output2(col_name):
    ...
    DEBUG VERSION: Logs each pattern check and match result.
    """
